...
Shader "SinCourse/PBR简化"
{
	Properties
	{
		...
		_OffsetTex2("OffsetTex", 2D) = "white" {}
		_OffsetTexU2("OffsetTexU", Float) = 0
		_OffsetTexV2("OffsetTexV", Float) = 0
		_VertexOffsetIntensity("VertexOffsetIntensity", Float) = 0
		_OffsetMaskTex2("OffsetMaskTex", 2D) = "white" {}
		_OffsetMaskTexU2("OffsetMaskTexU", Float) = 0
		_OffsetMaskTexV2("OffsetMaskTexV", Float) = 0
		[Toggle(_OPACITYMASKTEXSWITCH2_ON)] _OpacityMaskTexSwitch2("OpacityMaskTexSwitch", Float) = 1
		_OpacityMaskTex2("OpacityMaskTex", 2D) = "white" {}
		_OpacityMaskTexU2("OpacityMaskTexU", Float) = 0
		_OpacityMaskTexV2("OpacityMaskTexV", Float) = 0
		[Toggle]_OffsetMaxTexFrequencyToOpacityMaskTex("OffsetMaxTexFrequencyToOpacityMaskTex", Float) = 0
		[Toggle(_DITHERSWITCH2_ON)] _DitherSwitch2("DitherSwitch", Float) = 0
		_DitherBias2("DitherBias", Float) = 0
		_MaskAddBias2("MaskAddBias", Float) = 0
		_AlphaTex3("AlphaTex1", 2D) = "white" {}
		_AlphaTex1U2("AlphaTex1U", Float) = 0
		_AlphaTex1V2("AlphaTex1V", Float) = 0
		...
		[Toggle(_SECTEXDISTORTIONUV1_ON)] _SecTexDistortionUV1("SecTexDistortionUV", Float) = 0
		[Toggle(_OFFSETTEXDISTORTIONUV2_ON)] _OffsetTexDistortionUV2("OffsetTexDistortionUV", Float) = 0
	...
	SubShader
	{
		...
		#pragma target 4.6
		#pragma shader_feature _OFFSETTEXDISTORTIONUV2_ON
		...
		#pragma shader_feature _SECTEXDISTORTIONUV1_ON
		#pragma shader_feature _DITHERSWITCH2_ON
		#pragma shader_feature _OPACITYMASKTEXSWITCH2_ON
		...
		uniform sampler2D _OffsetTex2;
		uniform float4 _OffsetTex2_ST;
		uniform float _OffsetTexU2;
		uniform float _OffsetTexV2;
		uniform sampler2D _DistortionTex;
		uniform float4 _DistortionTex_ST;
		uniform float _DistortionU;
		uniform float _DistortionV;
		uniform float _DistortionIntensity;
		uniform sampler2D _OffsetMaskTex2;
		uniform float4 _OffsetMaskTex2_ST;
		uniform float _OffsetMaskTexU2;
		uniform float _OffsetMaskTexV2;
		...
		uniform float _AO;
		uniform float _MaskAddBias2;
		uniform sampler2D _OpacityMaskTex2;
		uniform half _OffsetMaxTexFrequencyToOpacityMaskTex;
		uniform float4 _OpacityMaskTex2_ST;
		uniform float _OpacityMaskTexU2;
		uniform float _OpacityMaskTexV2;
		uniform sampler2D _AlphaTex3;
		uniform float4 _AlphaTex3_ST;
		uniform float _AlphaTex1U2;
		uniform float _AlphaTex1V2;
		uniform float _DitherBias2;
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float2 uv0_OffsetTex2 = v.texcoord.xy * _OffsetTex2_ST.xy + _OffsetTex2_ST.zw;
			half2 appendResult88 = (half2(( _OffsetTexU2 * _Time.y ) , ( _Time.y * _OffsetTexV2 )));
			half2 temp_output_96_0 = ( uv0_OffsetTex2 + appendResult88 );
			...
			float2 uv1_DistortionTex = v.texcoord1.xy * _DistortionTex_ST.xy + _DistortionTex_ST.zw;
				...
				float2 staticSwitch28 = uv1_DistortionTex;
			#else
				float2 staticSwitch28 = uv0_DistortionTex;
			#endif
			...
			#ifdef _OFFSETTEXDISTORTIONUV2_ON
				float3 staticSwitch108 = lerpResult103;
			#else
				float3 staticSwitch108 = float3( temp_output_96_0 ,  0.0 );
			#endif
			float2 uv0_OffsetMaskTex2 = v.texcoord.xy * _OffsetMaskTex2_ST.xy + _OffsetMaskTex2_ST.zw;
			half2 appendResult99 = (half2(( _OffsetMaskTexU2 * _Time.y ) , ( _Time.y * _OffsetMaskTexV2 )));
			half4 temp_output_116_0 = ( tex2Dlod( _OffsetTex2, float4( staticSwitch108.xy, 0, 0.0) ) * tex2Dlod( _OffsetMaskTex2, float4( ( uv0_OffsetMaskTex2 + appendResult99 ), 0, 0.0) ) );
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			o.Alpha = 1;
			float2 uv0_OffsetTex2 = i.uv_texcoord * _OffsetTex2_ST.xy + _OffsetTex2_ST.zw;
			half2 appendResult88 = (half2(( _OffsetTexU2 * _Time.y ) , ( _Time.y * _OffsetTexV2 )));
			half2 temp_output_96_0 = ( uv0_OffsetTex2 + appendResult88 );
			half3 lerpResult103 = lerp( half3( temp_output_96_0 ,  0.0 ) , DistortionUV34 , DistortionIndeisty35);
			#ifdef _OFFSETTEXDISTORTIONUV2_ON
				...
				float3 staticSwitch108 = float3( temp_output_96_0 ,  0.0 );
			#endif
			float2 uv0_OffsetMaskTex2 = i.uv_texcoord * _OffsetMaskTex2_ST.xy + _OffsetMaskTex2_ST.zw;
			half2 appendResult99 = (half2(( _OffsetMaskTexU2 * _Time.y ) , ( _Time.y * _OffsetMaskTexV2 )));
			half4 temp_output_116_0 = ( tex2D( _OffsetTex2, staticSwitch108.xy ) * tex2D( _OffsetMaskTex2, ( uv0_OffsetMaskTex2 + appendResult99 ) ) );
			...
			float2 uv0_OpacityMaskTex2 = i.uv_texcoord * _OpacityMaskTex2_ST.xy + _OpacityMaskTex2_ST.zw;
			half2 appendResult100 = (half2(( _OpacityMaskTexU2 * _Time.y ) , ( _Time.y * _OpacityMaskTexV2 )));
			half3 desaturateInitialColor118 = tex2D( _OpacityMaskTex2, (( _OffsetMaxTexFrequencyToOpacityMaskTex )?( ( appendResult99 + uv0_OpacityMaskTex2 ) ):( ( uv0_OpacityMaskTex2 + appendResult100 ) )) ).rgb;
			...
			#ifdef _OPACITYMASKTEXSWITCH2_ON
			...
			half2 appendResult113 = (half2(( _AlphaTex1U2 * _Time.y ) , ( _Time.y * _AlphaTex1V2 )));
			half3 desaturateInitialColor120 = tex2D( _AlphaTex3, ( uv0_AlphaTex3 + appendResult113 ) ).rgb;
			...
			half clampResult141 = clamp( ( _MaskAddBias2 + ( staticSwitch123 * (desaturateVar120).x ) ) , 0.0 , 1.0 );
			...
			dither131 = step( dither131, ( temp_output_128_0 + _DitherBias2 ) );
			#ifdef _DITHERSWITCH2_ON
...
/*ASEBEGIN
Version=17800
0;0;1920;1029;3240.098;2043.587;1.930163;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;22;-5746.467,-1166.062;Float;False;Property;_DistortionU;DistortionU;38;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;23;-5746.467,-1086.062;Float;False;Property;_DistortionV;DistortionV;39;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;28;-5511.467,-1365.062;Float;False;Property;_Distortion2UV;Distortion2UV;41;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT2;0,0;False;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;6;FLOAT2;0,0;False;7;FLOAT2;0,0;False;8;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;78;-4998.611,593.859;Float;False;Property;_OffsetTexV2;OffsetTexV;21;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;21;-4923.149,-1641.517;Inherit;False;312.6667;165.6667;UV扭曲强度;1;33;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;77;-5001.611,441.859;Float;False;Property;_OffsetTexU2;OffsetTexU;20;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;76;-5026.611,525.859;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;31;-5106.468,-1246.062;Inherit;True;Property;_DistortionTex;DistortionTex;37;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-4873.149,-1592.574;Float;False;Property;_DistortionIntensity;DistortionIntensity;40;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;83;-5060.424,1505.952;Float;False;Property;_OpacityMaskTexV2;OpacityMaskTexV;29;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;87;-5060.645,895.7062;Float;False;Property;_OffsetMaskTexU2;OffsetMaskTexU;24;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;86;-5025.645,981.7052;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;84;-5063.424,1353.953;Float;False;Property;_OpacityMaskTexU2;OpacityMaskTexU;28;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;89;-5057.645,1047.705;Float;False;Property;_OffsetMaskTexV2;OffsetMaskTexV;25;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;106;-5054.466,1963.236;Float;False;Property;_AlphaTex1V2;AlphaTex1V;36;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;105;-5057.466,1811.233;Float;False;Property;_AlphaTex1U2;AlphaTex1U;35;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;63;-1646.848,-951.0601;Float;False;Property;_NormalTexU;NormalTexU;11;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;108;-3892.302,485.844;Float;False;Property;_OffsetTexDistortionUV2;OffsetTexDistortionUV;44;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;61;-1643.848,-799.06;Float;False;Property;_NormalTexV;NormalTexV;12;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;112;-3529.332,398.4249;Inherit;True;Property;_OffsetTex2;OffsetTex;19;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;133;-3583.973,790.1714;Inherit;True;Property;_OffsetMaskTex2;OffsetMaskTex;23;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ToggleSwitchNode;147;-3949.089,1234.292;Half;False;Property;_OffsetMaxTexFrequencyToOpacityMaskTex;OffsetMaxTexFrequencyToOpacityMaskTex;30;0;Create;True;0;0;False;0;0;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;117;-3521.662,1663.579;Inherit;True;Property;_AlphaTex3;AlphaTex1;34;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;51;-2393.042,-1304.332;Float;False;Property;_MainTexU;MainTexU;8;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;50;-2388.714,-1151.002;Float;False;Property;_MainTexV;MainTexV;9;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;123;-2174.82,1232.669;Float;False;Property;_OpacityMaskTexSwitch2;OpacityMaskTexSwitch;26;0;Create;True;0;0;False;0;0;1;1;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;14;-2522.667,-215.5186;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;12;-2497.667,-299.5188;Float;False;Property;_SecTexU;SecTexU;15;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;72;-818.439,-819.2756;Float;False;Property;_NormalTexDistortionUV;NormalTexDistortionUV;42;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-2494.667,-147.5187;Float;False;Property;_SecTexV;SecTexV;16;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;73;-708.2676,-721.0609;Float;False;Property;_NormalIntensity;NormalIntensity;13;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;139;-1453.226,316.6716;Float;False;Property;_MaskAddBias2;MaskAddBias;33;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.WorldReflectionVector;37;-1956.014,-1810.812;Inherit;False;True;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SamplerNode;42;-1755.773,-1844.161;Inherit;True;Property;_CubeMapTex;CubeMapTex;17;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Cube;6;0;SAMPLER2D;;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;41;-1687.527,-1920.249;Float;False;Property;_CubeMapIntensity;CubeMapIntensity;18;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;40;-1702.052,-1560.997;Float;False;Property;_MainColor;MainColor;6;1;[HDR];Create;True;0;0;False;0;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;39;-1758.338,-1341.143;Inherit;True;Property;_MainTex;MainTex;7;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;129;-746.6322,924.5721;Float;False;Property;_DitherBias2;DitherBias;32;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;146;-1392.328,-243.2441;Float;False;Property;_SecTexDistortionUV1;SecTexDistortionUV;43;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.CommentaryNode;2;-661.3116,-629.9697;Inherit;False;409.3331;225.6667;AO;2;9;5;;1,1,1,1;0;0
Node;AmplifyShaderEditor.ColorNode;46;-1054.867,-1701.557;Float;False;Property;_AllColor;AllColor;5;1;[HDR];Create;True;0;0;False;0;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;126;-1916.562,945.2021;Float;False;Property;_VertexOffsetIntensity;VertexOffsetIntensity;22;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;7;-611.9528,-101.7984;Float;False;Property;_Metallic;Metallic;4;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;5;-611.3116,-519.9697;Float;False;Property;_AO;AO;2;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;6;-612.9528,-301.7984;Float;False;Property;_Gloss;Gloss;3;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;4;-1067.905,-345.6356;Inherit;True;Property;_SecTex;SecTex;14;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DitheringNode;131;-422.5526,886.1992;Inherit;False;0;False;3;0;FLOAT;0;False;1;SAMPLER2D;;False;2;FLOAT4;0,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;58;-589.4352,-1606.366;Float;False;Property;_EmissionSwitch;EmissionSwitch;1;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StaticSwitch;132;-174.6906,211.696;Float;False;Property;_DitherSwitch2;DitherSwitch;31;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=F12ACEC06BDE9C4A3D1C9893D906767731A64116